...
public class Controller {
    ...
    void btnRegistrationOnaction(ActionEvent event) {
        ...
        if (pswPassword.getText() == null || pswPassword.getText().equals("")) {
            ...
            lblPasswordError.setText("Confirmed password is different");
        }

        if (lblPasswordError.getText().equals("") && lblUsernameError.getText().equals("") &&
                lblEmailError.getText().equals("") && lblPhoneNumberError.getText().equals("")){

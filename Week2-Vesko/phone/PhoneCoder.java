...
public class PhoneCoder
{
    ...
    public String decode(String encodedPhoneNumber)
    {
        if(encodedPhoneNumber != null && encodedPhoneNumber.length() == 4)
        {
            int originalNumber = Integer.parseInt(encodedPhoneNumber);
